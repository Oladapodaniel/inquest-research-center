<template>
  <div>
    ...
    <nav
      class="flex-no-wrap relative flex w-full items-center justify-between bg-white-100 py-2 shadow-md shadow-black/5 dark:bg-neutral-600 dark:shadow-black/10 lg:flex-wrap lg:justify-start lg:py-4"
      data-te-navbar-ref>
      <div class="md:container mx-auto flex w-full flex-wrap items-center justify-between px-3">
        ...
        <div class="!visible hidden flex-grow basis-[100%] items-center lg:!flex lg:basis-auto"
          ...
          <a class="mb-4 mr-2 mt-3 flex items-center text-neutral-900 hover:text-neutral-900 focus:text-neutral-900 dark:text-neutral-200 dark:hover:text-neutral-400 dark:focus:text-neutral-400 lg:mb-0 lg:mt-0"
            href="#">
            <img src="https://tecdn.b-cdn.net/img/logo/te-transparent-noshadows.webp" style="height: 15px" alt=""
              loading="lazy" />
          </a>
          ...
          <ul class="list-style-none mr-auto flex flex-col pl-0 lg:flex-row" data-te-navbar-nav-ref>
            <li class="mb-4 lg:mb-0 lg:pr-2" data-te-nav-item-ref>
              <!-- Dashboard link -->
              <a class="inter-regular text-neutral-500 hover:text-neutral-700 focus:text-neutral-700 disabled:text-black/30 dark:text-neutral-200 dark:hover:text-neutral-300 dark:focus:text-neutral-300 lg:px-2 [&.active]:text-black/90 dark:[&.active]:text-zinc-400"
                href="#" data-te-nav-link-ref>Home</a>
            </li>
            <!-- Team link -->
            <li class="mb-4 lg:mb-0 lg:pr-2" data-te-nav-item-ref>
              <a class="inter-regular text-neutral-500 hover:text-neutral-700 focus:text-neutral-700 disabled:text-black/30 dark:text-neutral-200 dark:hover:text-neutral-300 dark:focus:text-neutral-300 lg:px-2 [&.active]:text-black/90 dark:[&.active]:text-neutral-400"
        ...
        <div class="relative flex items-center">
          ...
          <div class="relative ml-10" data-te-dropdown-ref>
            ...
            <ul
              ...
              <li id="theme-switcher" @click="themeToggler('light')" data-theme="light">
                <a class="block w-full whitespace-nowrap bg-transparent px-4 py-2 text-sm font-normal text-neutral-700 hover:bg-neutral-100 active:text-neutral-800 active:no-underline disabled:pointer-events-none disabled:bg-transparent disabled:text-neutral-400 dark:text-neutral-200 dark:hover:bg-white/30"
                  ...
                  <span data-theme-name="light" class="mx-5">Light</span>
                </a>
              </li>
              <li id="theme-switcher" @click="themeToggler('dark')" data-theme="light">
                <a class="block w-full whitespace-nowrap bg-transparent px-4 py-2 text-sm font-normal text-neutral-700 hover:bg-neutral-100 active:text-neutral-800 active:no-underline disabled:pointer-events-none disabled:bg-transparent disabled:text-neutral-400 dark:text-neutral-200 dark:hover:bg-white/30"
                  href="#" data-te-dropdown-item-ref>
                  ...
                  <span data-theme-name="dark" class="mx-5">Dark</span>
                </a>
              </li>
            </ul>
          </div>
...
const themeToggler = (item) => {
  onThemeSwitcherItemClick(item)
}
